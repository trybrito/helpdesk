...
describe('Update technician', () => {
	...
	it('should not be able to update technician profile e-mail using a existent admin e-mail', async () => {
	...
	it('should not be able to update technician profile e-mail using a existent technician e-mail', async () => {
		const email = 'same@mail.com'
	...
	it('should not be able to update technician profile e-mail using a existent customer e-mail', async () => {
		const email = 'same@mail.com'
